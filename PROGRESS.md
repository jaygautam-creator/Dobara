...
verbatim in `README.md`'s "Honest metrics" section. Break-even statement (the
`hazard_per_failure_notification` sensitivity sweep) still not built — stated as
outstanding in the README, not implied to exist.

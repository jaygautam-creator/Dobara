...
- [x] **Validation: output matches published benchmarks** (failure rate 20.2%, recovery rate 46.4%, revocation ratio 9.1%/mandate over 8 cycles — all within the declared sanity bands; see `sim/run.py` BENCHMARKS)

...
- **The Control Room's "rejected alternatives" list is mostly noise at video bitrate**: rows
  ...
  worth visually de-emphasizing (dimmer color, or collapsed by default) everything below the
  top 2–3 rows before recording.
